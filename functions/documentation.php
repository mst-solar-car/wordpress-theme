      ...
      <article id="shortcodes">
        ...
        <section id="columns">
          ...
          <code>
            ...
            [one_fourth]Content here[/one_third]
          </code>
          Whenever you use these, you will usually have three one_thirds, or four one_fourths, in a row because the columns are designed to be next to each other, to take up the whole screen.
        </section> <!-- End Columns -->
