  ...
  ?>
       <style type="text/css">
         ...
         .post-title a::after, .timeline-entry a::after {background: <?php echo $primary; ?>; }
          ...
          {
            background: <?php rgba( $rgb_primary, '0.9' ); ?>;
          }
          ...
          { border: 1px solid <?php echo $primary; ?>; color: <?php echo $primary; ?>; }

          .sub-heading > a::after,
          .preview-sub-heading > a::after,
          .author-meta > .author-meta-description > a::after { background: <?php echo $font_color; ?>}
       </style>
  <?php
} );
